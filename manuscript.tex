...
\subsection{Capture near-eye images and synthesize eye movement tracking data}
...
reproducible eye-based measurements in VAC-related experiments \cite{AR_Vergence_Depth_OST,AR_Haploscope_Replication}.
...
\(1.108\,\mathrm{cm}\) \cite{Improved_vergence_and_accommodation}. Ozhan et al. further combined a Purkinje imaging setup with a
...
evaluation with two-point calibration \cite{Dynamic_accommodation_Purkinje}.
...
with scores ranging from 77.54 to 94.59 \cite{RIT-Eyes}. 
...
under near-field point lights and structured illumination \cite{EyeNeRF}\cite{Realistic_nerf_eyes};
