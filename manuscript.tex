...
to be back-propagated to lens design parameters \cite{na2024fluidiclenses}. Similarly, 
...
network \cite{yang2024hybridlens}. These works suggest that optical simulation can be part of the design loop;
...
with only a \(5\%\) sampling ratio \cite{zhai2022antinoise}, diffusion-based style transfer reduced 
synthetic-to-real FID to \(54.56\) compared with \(65.31\) and \(73.26\) for prior 
baselines \cite{chigot2025diffusionstyletransfer}, and physics-informed diffusion reduced physical 
residuals by about two orders of magnitude in a Darcy-flow task and by \(33\%\)--\(35\%\) in topology 
optimization \cite{bastek2025pidm}.
